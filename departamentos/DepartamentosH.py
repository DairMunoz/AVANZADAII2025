...
# Ejerciocio 3 examen (division de dos numeros)
            elif deseo == 3:
                 for i in range(2):
...
#Ejercicio 8 examen (Calcular el promedio )
            elif deseo == 4:    
                cal1 = int(input("Ingrese su primer calificacion: "))
                cal2 = int(input("Ingrese su segunda califiacion: "))
                cal3 = int(input("Ingrese su tercer calificacion: "))
                prom = (cal1 + cal2 + cal3) / 3
                if prom >= 95:
                    print("Felicidades, usted es de excelencia academica: ",prom)

                if prom < 95:
                    print("Usted no es de excelencia academica")    
